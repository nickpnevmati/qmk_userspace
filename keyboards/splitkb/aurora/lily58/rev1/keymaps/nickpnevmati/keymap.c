...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(4), KC_TAB, KC_W, KC_L, KC_Y, KC_P, KC_B, KC_Z, KC_F, KC_O, KC_U, KC_QUOT, KC_NO, KC_NO, KC_C, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_A, KC_NO, KC_NO, KC_Q, KC_J, KC_V, KC_D, KC_K, KC_NO, KC_NO, KC_X, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_SPC, KC_ENT, KC_NO, KC_NO, KC_NO)
};
